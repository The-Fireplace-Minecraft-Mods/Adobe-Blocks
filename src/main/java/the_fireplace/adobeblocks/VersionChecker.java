...
public class VersionChecker implements IModGuiFactory {
	static final String HostMODID=AdobeBlocks.MODID;
	...
	public VersionChecker(){
		curseCode = AdobeBlocks.curseCode;
	}
	...
	public void init(FMLInitializationEvent event){
		HostVERSION=AdobeBlocks.VERSION;
		tryNotifyDynious();
	...
	private String getVersionFromJson(){
		try{
			...
			if(file.exists()) {
				...
				int versionindex = jarindex + "AdobeBlocks-".length();
