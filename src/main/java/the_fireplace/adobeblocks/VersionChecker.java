...
public class VersionChecker {
	private static final String HostMODID=AdobeBlocks.MODID;
	private static final String HostMODNAME=AdobeBlocks.MODNAME;
	private static final String HostVERSION=AdobeBlocks.VERSION;
	...
	public VersionChecker(){
		latest = stringAt(AdobeBlocks.LATEST);
		downloadURL = AdobeBlocks.downloadURL;
	}
