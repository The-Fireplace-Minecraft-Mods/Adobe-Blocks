 ...
 */
public class OakBeam extends Block {
	...
	public OakBeam() {
		super(Material.wood);
		setUnlocalizedName("oak_crossbeam");
	...
	public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos) {
		...
		return block == Blocks.barrier ? false : ((!(block instanceof OakBeam) || block.getMaterial() != this.blockMaterial) ? (block.getMaterial().isOpaque() && block.isFullCube() ? block.getMaterial() != Material.gourd : false) : true);
	}
